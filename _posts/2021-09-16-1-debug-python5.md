---
title:  "[Python] ERROR: Could not install packages due to an EnvironmentError: [Errno 13] Permission denied"
...
pip로 package를 설치하던 중 아래와 같은 오류 메시지가 발생하였습니다.
<p class="error_msg">
...
pyvenv.cfg 파일의 include-system-site-packages 옵션을 True로 설정해서 해결하였습니다.
pyvenv.cfg 파일은 venv 환경을 사용하는 경우 해당 폴더에서 확인할 수 있습니다.
...
이렇게 수정해 준 뒤 다시 시도하면 아래와 같이 성공적으로 설치되는 것을 확인할 수 있습니다.
