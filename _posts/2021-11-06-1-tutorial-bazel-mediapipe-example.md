...
Bazel과 MediaPipe는 튜토리얼을 차례대로 따라왔다면 설치되어 있을 것이고 SDK도 Android Studio를 사용하고 있다면 설치되어 있을 것이다. 
그러므로 여기서는 NDK 설치하는 방법만 안내하고자 한다.

(1-1) Android Studio에서 File-Settings로 진입한다.

<p><img src="/assets/images/21123122.png" /></p>

(1-2) 검색창에 sdk를 검색하여 Appearance&Behavior - System Settings - Android SDK로 진입한다.

<p><img src="/assets/images/22010203.jpg" /></p>

(1-3) SDK Tools 탭을 클릭한다.

<p><img src="/assets/images/22010204.jpg" /></p>

(1-4) 아래 "Show Package Details" 앞의 체크박스를 활성화한다. 이 옵션을 활성화하면 버전을 선택할 수 있다. 

<p><img src="/assets/images/22010214.png" /></p>

(1-5) NDK 버전을 선택한다. Bazel은 NDK 21버전 까지만 지원하므로 21버전을 선택한다. 앞의 체크박스를 활성화하여 선택한 후 OK 버튼을 누른다.

<p><img src="/assets/images/22010215.png" /></p>

(1-6) 변경을 확인하는 창이 뜨면 OK 버튼을 눌러 NDK를 설치한다.

<p><img src="/assets/images/22010216.png" /></p>

(1-7) 설치가 완료되면 Finish 버튼을 눌러 빠져나온다.

<p><img src="/assets/images/22010217.png" /></p>
...
(3-3) "java" 폴더 안에는 "com/example/mediapipe/helloworld" 경로를 생성한다.
