---
title:  "[블로그] Cannot load such file -- tzinfo 에러"
...
minimal-mistake 스킨을 사용 중에 타임존 설정 후 jekyll 서버를 실행시켰더니 아래와 같은 오류가 발생하였습니다.
<p class="code"><img src="/assets/images/21090604.png" /></p>

webrick과 마찬가지로 tzinfo가 없어서 발생하는 오류입니다.
다음 명령어로 tzinfo와 tzinfo-data를 설치합니다.
...
그리고 설치한 tzinfo와 tzinfo-data를 번들에 추가합니다.
...
그러고나서 실행하면 정상적으로 실행되는 것을 확인할 수 있습니다.
